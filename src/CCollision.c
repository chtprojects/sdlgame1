...
void
each_collision_in(quad_list *b, CQuad* collider_pairs[], int *num_colliders) {
    int num_found  =0 ;
...
void
Collision_update_all(CCollision_box_2d *b2) {
...
Uint32
screen_coords_to_box_id(CCollision_box_2d *b2, float x, float y) {
